...
export default class GameScene extends Phaser.Scene {
  ...
  create() {
    let bgAudio = this.sound.add("game-music", { loop: true });
    bgAudio.play();
    this.add.image(
    ...
    this.covids.children.iterate(function (child) {
      child.setGravityY(0);
  ...
  update() {
    ...
    } else if (this.cursors.up.isUp && this.personaje.body.onFloor() && this.personaje.jumps !== 0) {
      this.personaje.jumps = 0;
